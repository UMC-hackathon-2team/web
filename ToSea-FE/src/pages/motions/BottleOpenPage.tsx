...
const BottleOpenPage = () => {
	...
	return (
		<div className='relative w-full h-screen overflow-hidden bg-linear-to-b from-[#3d4d99] to-[#2b3a80] flex flex-col items-center justify-center'>
			{/* 반짝이는 반딧불이들 */}
			...
			>
				<FilledButton label='즉시열어보기' onClick={handleOpenBottle} className='px-16 py-4 text-lg' />
			</motion.div>
		</div>
	)
}
